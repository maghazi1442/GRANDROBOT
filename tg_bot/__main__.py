...
Hello! my name *{ANNAJIYAH MEDIA CENTER}*.
...
TECHNO_IMG = "https://telegra.ph/file/97519f3fdbeca2835ba83.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/joincontact")],
                                                                                   [InlineKeyboardButton(text="Tambahkan bot ke group",
                                                                       url="t.me/AMC_00_Bot?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="channels",
                                                                       url="https://t.me/joinchat/EGLAkwl9tmk3YWJh")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("ANNAJIYAH MEDIA CENTER")
